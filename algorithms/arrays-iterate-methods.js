...
describe("Objects", () => {
  ...
  it("Should implement filter", () => {
    const obj = new Obj({ a: 1, b: 2 });
    assert.deepEqual(obj.filter((value, key) => value > 0), {
      a: 1, b: 2
    });
  ...
  it("Should implement reduce", () => {
    ...
    const obj2 = new Obj({ a1: { b1: 1, b2: 2 }, a2: { b3: 3, b4: 4 } }); assert.deepEqual(obj2.reduce((accumulator, value, key) => ({ ...accumulator, ...value }), {}), { b1: 1, b2: 2, b3: 3, b4: 4 });
  });
  ...
  it("Should flatten objects", () => {
    ...
    assert.deepEqual(flatten(new Obj({ a1: { b1: 1, b2: { c1: 1, c2: 2 } }, a2: { b3: 3, b4: { c3: 3, c4: 4 } } })), { b1: 1, c1: 1, c2: 2, b3: 3, c3: 3, c4: 4 });
  });
});
